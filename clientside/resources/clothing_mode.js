...
API.onUpdate.connect(function () {
    ...
    if (API.isDisabledControlPressed(5 /* LookLeftOnly */)) {
    }
...
function setupClothingMode() {
    ...
    n_Face_Max = API.returnNative("GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0);
    n_Mask_Max = API.returnNative("GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 1);
    n_Hair_Max = API.returnNative("GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 2);
...
function switchClothing(amount) {
    switch (currentIndex) {
        case 0:
            ...
            t_Face_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_Face);
            break;
        case 1:
            n_Mask += amount;
            n_Mask = checkForZeroOrMax(n_Mask, n_Mask_Max);
            t_Mask_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_Mask);
            break;
        case 2:
            n_Hair += amount;
            n_Hair = checkForZeroOrMax(n_Hair, n_Hair_Max);
            t_Hair_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_Hair);
            break;
        case 3:
            n_Torso += amount;
            n_Torso = checkForZeroOrMax(n_Torso, n_Torso_Max);
            t_Torso_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_Torso);
            break;
        case 4:
            n_Legs += amount;
            n_Legs = checkForZeroOrMax(n_Legs, n_Legs_Max);
            t_Legs_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_Legs);
            break;
        case 5:
            n_Bags += amount;
            n_Bags = checkForZeroOrMax(n_Bags, n_Bags_Max);
            t_Bags_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_Bags);
            break;
        case 6:
            n_Feet += amount;
            n_Feet = checkForZeroOrMax(n_Feet, n_Feet_Max);
            t_Feet_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_Feet);
            break;
        case 7:
            n_Accessories += amount;
            n_Accessories = checkForZeroOrMax(n_Accessories, n_Accessories_Max);
            t_Accessories_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_Accessories);
            break;
        case 8:
            n_Undershirt += amount;
            n_Undershirt = checkForZeroOrMax(n_Undershirt, n_Undershirt_Max);
            t_Undershirt_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_Undershirt);
            break;
        case 9:
            n_BodyArmor += amount;
            n_BodyArmor = checkForZeroOrMax(n_BodyArmor, n_BodyArmor_Max);
            t_BodyArmor_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_BodyArmor);
            break;
        case 10:
            n_Decals += amount;
            n_Decals = checkForZeroOrMax(n_Decals, n_Decals_Max);
            t_Decals_Max = API.returnNative("GET_NUMBER_OF_PED_TEXTURE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 0, n_Decals);
            break;
        case 11:
            n_Tops += amount;
