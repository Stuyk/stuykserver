...
function addSubIndex() {
    ...
    switch (currentIndex) {
        case 0:
            n_hair += 1;
            var n_hair_max = API.returnNative("GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS", 0 /* Int */, API.getLocalPlayer(), 2);
        ...
        case 1:
            n_hair_color += 1;
            var n_hair_color_max = API.returnNative("_GET_NUM_HAIR_COLORS", 0 /* Int */);
        ...
        case 2:
            n_highlight += 1;
            var n_highlight_max = API.returnNative("_GET_NUM_HAIR_COLORS", 0 /* Int */);
        ...
        case 3:
            n_beard += 1;
            var n_beard_max = API.returnNative("_GET_NUM_HEAD_OVERLAY_VALUES", 0 /* Int */, 1);
        ...
        case 5:
            n_eyebrows += 1;
            var n_eyesbrows_max = API.returnNative("_GET_NUM_HEAD_OVERLAY_VALUES", 0 /* Int */, 2);
