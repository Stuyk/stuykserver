...
function drawWaypoint() {
    ...
    marker = API.createMarker(Enums.MarkerType.VerticalCylinder, positions[0], new Vector3(), new Vector3(), new Vector3(2, 2, 2), 63, 137, 255, 150);
...
function drawCapture() {
    ...
    marker = API.createMarker(Enums.MarkerType.VerticalCylinder, positions[0], new Vector3(), new Vector3(), new Vector3(5, 5, 5), 63, 137, 255, 150);
    blip = API.createBlip(positions[0]);
    API.setBlipSprite(blip, 1);
    API.setBlipColor(blip, 67);
    currentTaskPosition = positions[0];
...
function drawHack() {
    ...
    marker = API.createMarker(Enums.MarkerType.UpsideDownCone, positions[0], new Vector3(), new Vector3(), new Vector3(1, 1, 1), 63, 137, 255, 150);
    blip = API.createBlip(positions[0]);
    API.setBlipSprite(blip, 1);
    API.setBlipColor(blip, 67);
    currentTaskPosition = positions[0];
